    ...
    const helpEmbed = {
        ...
        fields: [{ //kay im gonna start copying the stuff from the website. 
            ...
            },
            {
                ...
                value: "this command is mod only. To enable new voicechats to the bot, or update existing voice chats with a new text chat. Usage: $enablechs vcId1, vcId2, ..., vcIdn, txtChId"
            },
            {
